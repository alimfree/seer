---
title: "How to Start an RPM Program in Primary Care: A Step-by-Step Guide"
description: "Learn how to start an RPM program in primary care with this step-by-step guide covering patient selection, devices, billing, and compliance for diabetic populations."
date: "2026-03-05"
author: "Mohammed Ali"
tags: ["rpm", "operations", "getting-started"]
image: "/blog/starting-rpm-program.webp"
status: "published"
---
...
1. **Verbal or written consent** that the patient agrees to receive RPM services
2. **Explanation of what data will be collected** and how it will be used
3. **Notification that the patient may receive cost-sharing** (copays or coinsurance)
4. **Documentation in the EHR** with a date stamp and the name of the staff member who obtained consent
